...
export const sendVerifyOrganizationEmail = async (email: string, verificationLink: string, org: Organization) => {
  const text = `
    # Knovolo
    ...
    Thank you for signing up with Knovolo. To activate your organization account, please verify your email address by clicking the Link below:

    $${verificationLink}

    This verification link will expire in 14 days. If you don't verify your organization within this timeframe, your account will be scheduled for deletion.
...
>
                                            ...
                                            <tr>
                                              <td class="t30">
                                                ...
                                                >
                                                  ...
                                                  Knovolo. To activate your
                                                  organization account, please
                                            ...
                                            <tr>
                                              <td class="t44">
                                                ...
                                                >
                                                  ...
                                                  expire in 14 days. If you
                                                  don&#39;t verify your
                                                  organization within this
                                                  timeframe, your account will
  ...
  return await sendEmail({to: email, subject: "Verify your Organization", text, html, type: "orgVerifyOrg", entity: org});
};