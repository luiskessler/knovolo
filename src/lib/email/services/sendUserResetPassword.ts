...
export const sendUserResetPasswordEmail = async (email: string, passwordResetLink: string, org: Organization, user: User) => {
  const text = `
    # Knovolo

    # Reset your Knovolo Password

    Hello,

    We received a request to reset your password for your Knovolo acciunt at ${org}. Click the button below to create a new password:

    $${passwordResetLink}

    This link will expire in 24 hours. If you didn't request this password reset, please ignore this email or contact your administrator.
...
>
                                            ...
                                            <tr>
                                              <td class="t30">
                                                <p
                                                  ...
                                                  "
                                                >
                                                  We received a request to reset your password for your Knovolo account at ${org}. Click the button below to create a new password:
                                                </p>
                                              </td>
                                            </tr>
                                          </table>
  ...
  return await sendEmail({to: email, subject: `Reset your Knovolo password`, text, html, type: "userPasswordResetLink", entity: user});
};